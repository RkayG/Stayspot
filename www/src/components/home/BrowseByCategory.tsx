...
const categories = [
  { icon: <Bed className="w-8 h-8 mx-auto mb-3" />, name: "Hotels", count: "3,245+" },
  { icon: <GlassWater className="w-8 h-8 mx-auto mb-3" />, name: "Lounges", count: "1,842+" },
  { icon: <Beer className="w-8 h-8 mx-auto mb-3" />, name: "Bars", count: "2,101+" },
  { icon: <Utensils className="w-8 h-8 mx-auto mb-3" />, name: "Restaurants", count: "2,532+" },
  { icon: <Palmtree className="w-8 h-8 mx-auto mb-3" />, name: "Resorts", count: "1,102+" },
  { icon: <CalendarDays className="w-8 h-8 mx-auto mb-3" />, name: "Event Centers", count: "842+" },
];
